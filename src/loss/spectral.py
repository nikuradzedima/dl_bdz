...
class MultiScaleSpectralLoss(nn.Module):
    ...
    def __init__(self, fft_sizes=None, sample_rate=16000, n_mels=64):
        super().__init__()
    ...
    def _build_mel_filterbank(self, n_fft):
        n_freqs = n_fft // 2 + 1
