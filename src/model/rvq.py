...
class ResidualVectorQuantizer(nn.Module):
    ...
    @torch.no_grad()
    def _initialize_codebooks(self, z_bsd):
    ...
    @torch.no_grad()
    def _ema_update(
        self, quantizer_idx, residual, indices
    ):
    ...
    def _replace_dead_codes(
        self, quantizer_idx, flat_residual
    ):
    ...
    @staticmethod
    @torch.no_grad()
    def _sample_vectors(x, num_vectors):
