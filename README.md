...
Реализация упрощенного нейросетевого аудиокодека SoundStream для
сжатия и восстановления речи на LibriSpeech
...
Для логирования в Comet ML создай `.env` в корне репозитория и заполни
